...
namespace WpfApp2 {
    ...
    public partial class auto76DataSet : global::System.Data.DataSet {
        ...
        public partial class ordersDataTable : global::System.Data.TypedTableBase<ordersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ordersRow AddordersRow(int id, int Number, int customer_id, int supplier_id, double Summ, int count, string Comment) {
        ...
        public partial class ordersRow : global::System.Data.DataRow {
            ...
            public int supplier_id {
                get {
                    return ((int)(this[this.tableorders.supplier_idColumn]));
                }
                set {
                    this[this.tableorders.supplier_idColumn] = value;
                }
            }
...
namespace WpfApp2.auto76DataSetTableAdapters {
    ...
    public partial class ordersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[orders] WHERE (([id] = @Original_id) AND ([Number] = @Original_Number) AND ([customer_id] = @Original_customer_id) AND ([supplier_id] = @Original_supplier_id) AND ((@IsNull_Summ = 1 AND [Summ] IS NULL) OR ([Summ] = @Original_Summ)) AND ((@IsNull_count = 1 AND [count] IS NULL) OR ([count] = @Original_count)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[orders] ([id], [Number], [customer_id], [supplier_id], [Summ], [count], [Comment]) VALUES (@id, @Number, @customer_id, @supplier_id, @Summ, @count, @Comment);
SELECT id, Number, customer_id, supplier_id, Summ, count, Comment FROM orders WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[orders] SET [id] = @id, [Number] = @Number, [customer_id] = @customer_id, [supplier_id] = @supplier_id, [Summ] = @Summ, [count] = @count, [Comment] = @Comment WHERE (([id] = @Original_id) AND ([Number] = @Original_Number) AND ([customer_id] = @Original_customer_id) AND ([supplier_id] = @Original_supplier_id) AND ((@IsNull_Summ = 1 AND [Summ] IS NULL) OR ([Summ] = @Original_Summ)) AND ((@IsNull_count = 1 AND [count] IS NULL) OR ([count] = @Original_count)));
SELECT id, Number, customer_id, supplier_id, Summ, count, Comment FROM orders WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Number, customer_id, supplier_id, Summ, count, Comment FROM dbo.orders" +
                "";
        ...
        public virtual int Delete(int Original_id, int Original_Number, int Original_customer_id, int Original_supplier_id, global::System.Nullable<double> Original_Summ, global::System.Nullable<int> Original_count) {
            ...
            if ((Original_Summ.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((double)(Original_Summ.Value));
            }
            else {
        ...
        public virtual int Insert(int id, int Number, int customer_id, int supplier_id, global::System.Nullable<double> Summ, global::System.Nullable<int> count, string Comment) {
        ...
        public virtual int Update(int id, int Number, int customer_id, int supplier_id, global::System.Nullable<double> Summ, global::System.Nullable<int> count, string Comment, int Original_id, int Original_Number, int Original_customer_id, int Original_supplier_id, global::System.Nullable<double> Original_Summ, global::System.Nullable<int> Original_count) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Number, int customer_id, int supplier_id, global::System.Nullable<double> Summ, global::System.Nullable<int> count, string Comment, int Original_id, int Original_Number, int Original_customer_id, int Original_supplier_id, global::System.Nullable<double> Original_Summ, global::System.Nullable<int> Original_count) {
            return this.Update(Original_id, Number, customer_id, supplier_id, Summ, count, Comment, Original_id, Original_Number, Original_customer_id, Original_supplier_id, Original_Summ, Original_count);
        }
    }
